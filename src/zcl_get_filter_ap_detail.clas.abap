CLASS zcl_get_filter_ap_detail DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-DATA mo_instance TYPE REF TO zcl_get_filter_ap_detail.

    CLASS-METHODS get_instance
      RETURNING VALUE(ro_instance) TYPE REF TO zcl_get_filter_ap_detail.
...
CLASS ZCL_GET_FILTER_AP_DETAIL IMPLEMENTATION.
